...
namespace haomo{
    namespace transtopic{
        ...
        void pcreUtils::init(){
            ...
            this->re = pcre_compile(regp, 0, &error, &erroffset, NULL);
            if (this->re == NULL){
        ...
        int pcreUtils::reg_match_general(
            ...
            while (start_offset < cstrlen){
                ...
                rc = pcre_exec(this->re, NULL, cstr, cstrlen, start_offset, 0, ovector, PCRE_OVECCOUNT);
                if (rc < 0){
                    return 0;
                }
        ...
        int pcreUtils::reg_replace_callback(
