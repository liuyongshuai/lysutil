...
void getJson(lysutil::httpsvr::httpRequest &req, lysutil::httpsvr::httpResponse &resp) {
    resp.setBody(
            "{\"q\":\"http s\",\"p\":false,\"g\":[{\"type\":\"sug\",\"sa\":\"s_1\",\"q\":\"http status 500\"},{\"type\":\"sug\",\"sa\":\"s_2\",\"q\":\"http status 400\"},{\"type\":\"sug\",\"sa\":\"s_3\",\"q\":\"http socket\"},{\"type\":\"sug\",\"sa\":\"s_4\",\"q\":\"http session\"},{\"type\":\"sug\",\"sa\":\"s_5\",\"q\":\"httpstatus404解决步骤\"},{\"type\":\"sug\",\"sa\":\"s_6\",\"q\":\"http status\"},{\"type\":\"sug\",\"sa\":\"s_7\",\"q\":\"http stat jseea\"},{\"type\":\"sug\",\"sa\":\"s_8\",\"q\":\"http socket tcp区别\"},{\"type\":\"sug\",\"sa\":\"s_9\",\"q\":\"http status 404-not found\"},{\"type\":\"sug\",\"sa\":\"s_10\",\"q\":\"http status 500解决\"}]}");
    resp.setJsonHeader();
}

int main(int argc, char *argv[]) {
    std::cerr << "start init log......" << std::endl;
    lysutil::comutils::fileUtils::mkDirsAll("logs");
    lysutil::comutils::CommLogger::getInstance()->init("logs", "logs");
    ...
    routers->addRouter(lysutil::httpsvr::routerItem{
    ...
    server->setPort(gconf->listen_port);
    server->start();
    return 0;
}