...
void httpFunc1(haomo::transtopic::httpRequest &req, haomo::transtopic::httpResponse &rsp){
    std::cout << "httpFunc1" << std::endl;
}

void httpFunc2(haomo::transtopic::httpRequest &req, haomo::transtopic::httpResponse &rsp){
...
int main(int argc, char *argv[]){
    ...
    std::shared_ptr <haomo::transtopic::httpRouter> routers = haomo::transtopic::httpRouter::get_instance();
    const haomo::transtopic::routerItem *rItem;
    routers->addRouter(haomo::transtopic::ROUTER_TYPE_PATH_INFO, "/abc/:aaaa:/:dddd", httpFunc1, "");
    routers->addRouter(haomo::transtopic::ROUTER_TYPE_PATH_INFO, "/abc/aaaa/dddd", httpFunc1, "");
